...
export default function HubSpotVsSalesforce() {
  return (
    <ComparisonLayout
      tool1="hubspot"
      tool2="salesforce"
      title="HubSpot vs Salesforce: Which CRM Is Best for Growing Businesses in 2026?"
      description="Compare HubSpot and Salesforce CRM solutions. Analyze ease of use, scaling, pricing structures, and enterprise customization."
    >
      <article className="max-w-4xl mx-auto py-4 prose lg:prose-xl text-gray-100">
        <h1 className="text-white text-3xl font-bold mb-6">HubSpot vs Salesforce: Which CRM Is Best for Growing Businesses in 2026?</h1>
        ...
        <h2 className="text-white text-2xl font-semibold mt-6 mb-4">1. Core Value Proposition</h2>
        <p className="mb-4">
